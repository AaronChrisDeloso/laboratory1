...
{
    public abstract class sourcetreeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static sourcetreeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(sourcetreeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<sourcetreeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<sourcetreeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<sourcetreeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<sourcetreeDbContext, Task<T>> func)
        {
            T result;
